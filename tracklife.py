...
def MatchLifeP1(round_img):
  lifebarP1 = round_img[45 : 30 + lifebar_h, 110 : 110 + lifebar_w]
  ...
  if np.sum(maskP1_high_life) > 0:
    ...
    cv.rectangle(round_img, (110 + min(w_valuesP1), 42), (110 + lifebar_w, 38 + lifebar_h - 4), (210,100,20), 1)
    cv.putText(round_img, (str(lifeP1_percent) + "%"), org=((110 + min(w_valuesP1) + int(lifeP1_wP1/2) - 10), 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(0, 0, 0),thickness=3)
    cv.putText(round_img, (str(lifeP1_percent) + "%"), org=((110 + min(w_valuesP1) + int(lifeP1_wP1/2) - 10), 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(255,255,255),thickness=1)
  if np.sum(maskP1_low_life) > 0:
    ...
    cv.rectangle(round_img, (110 + min(w_valuesP1), 41), (110 + lifebar_w, 38 + lifebar_h - 4), (210,100,20), 1)
    cv.putText(round_img, (str(lifeP1_percent) + "%"), org=((110 + min(w_valuesP1) + int(lifeP1_wP1/2) - 10), 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(0, 0, 0),thickness=3)
    cv.putText(round_img, (str(lifeP1_percent) + "%"), org=((110 + min(w_valuesP1) + int(lifeP1_wP1/2) - 10), 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(255,255,255),thickness=1)
  ...
  if np.sum(maskP1_high_life) > 0 and np.sum(maskP1_low_life) > 0:
    lifeP1_percent = 'error'
    # cv.putText(lifebarP1, ('error'), org=(int(lifebar_w/2), 15), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 0, 255),thickness=4)
    # cv.putText(lifebarP1, ('error'), org=(int(lifebar_w/2), 15), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(255, 255, 255),thickness=2)
...
def MatchLifeP2(round_img):
  lifebarP2 = round_img[45 : 30 + lifebar_h, 690 : 690 + lifebar_w]
  ...
  if np.sum(maskP2_high_life) > 0:
    ...
    cv.rectangle(round_img, (690, 42), (690 + lifeP2_wP2, 38 + lifebar_h - 4), (210,100,20), 1)
    cv.putText(round_img, (str(lifeP2_percent) + "%"), org=(690 + int(lifeP2_wP2/2) - 2, 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(0, 0, 0),thickness=3)
    cv.putText(round_img, (str(lifeP2_percent) + "%"), org=(690 + int(lifeP2_wP2/2) - 2, 38 + 16), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(255,255,255),thickness=1)
  ...
  if np.sum(maskP2_high_life) > 0 and np.sum(maskP2_low_life) > 0:
    lifeP2_percent = 'error'
    # cv.putText(lifebarP2, ('error'), org=(int(lifebar_w/2), 15), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(0, 0, 255),thickness=4)
    # cv.putText(lifebarP2, ('error'), org=(int(lifebar_w/2), 15), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=0.5, color=(255, 255, 255),thickness=2)
